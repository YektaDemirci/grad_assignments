...
void Graph::setE(std::string inp)
{
    ...
    while(temp != '\0')
    {
        ...
        else if (temp == '>')
        {
            ...
            {
                std::cout << "Error: Given edge value is invalid" << std::endl;
                break;
            }
            inter1.clear();
            inter2.clear();
...
void Graph::path(int source,int dest)
{
    ...
    if (color[dest] != 2)
    {
        std::cout << "Error: There is no path from given source to destination" << std::endl;
    }
    else
    {
        std::stack<int> path;
...
int main(int argc, char** argv) {
    ...
    while(!std::cin.eof())
    {
        ...
        else if(line[0]=='s')
        {
            ...
            if ( ( sour<(haritoDes.V+1) ) && ( des<(haritoDes.V+1) ) )
            {
                if (s == d)
                {
            ...
            {
                std::cout << "Error: The source or the destination is not valid" << std::endl;
            }
        }
    std::getline (std::cin,line);
    }
